...
allowing somebody to distribute a Bitcoin-Qt.app or suharcoin-qt-setup.exe with a valid
...
that the suharcoin-qt.exe file inside the installer had not been tampered with.
