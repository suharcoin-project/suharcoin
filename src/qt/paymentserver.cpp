...
const QString BITCOIN_IPC_PREFIX("suharcoin:");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click suharcoin: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start suharcoin: click-to-pay handler");
    else
...
{
    // clicking on suharcoin: URLs creates FileOpen events on the Mac:
